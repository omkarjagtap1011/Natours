...
var initMap = exports.initMap = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(mapContainer, locations) {
    var _yield$google$maps$im, Map, _yield$google$maps$im2, AdvancedMarkerElement, _yield$google$maps$im3, LatLngBounds, bounds;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          _yield$google$maps$im3 = _context2.sent;
          LatLngBounds = _yield$google$maps$im3.LatLngBounds;
          ...
          locations.forEach(function (loc) {
            ...
            var infoWindow = new google.maps.InfoWindow({
              content: "<div><strong>Day ".concat(loc.day, ": ").concat(loc.description, "</strong></div>")
            });
            infoWindow.open({
              anchor: marker,
              map: map,
  ...
  return function initMap(_x3, _x4) {
...
var _default = exports.default = isFetchSupported && (async config => {
  ...
  try {
    if (onUploadProgress && supportsRequestStream && method !== 'get' && method !== 'head' && (requestContentLength = await resolveBodyLength(headers, data)) !== 0) {
      ...
      if (_request.body) {
        data = (0, _trackStream.trackStream)(_request.body, DEFAULT_CHUNK_SIZE, fetchProgressDecorator(requestContentLength, (0, _progressEventReducer.default)(onUploadProgress)));
      }
    }
    ...
    if (supportsResponseStream && (onDownloadProgress || isStreamResponse)) {
      ...
      response = new Response((0, _trackStream.trackStream)(response.body, DEFAULT_CHUNK_SIZE, onDownloadProgress && fetchProgressDecorator(responseContentLength, (0, _progressEventReducer.default)(onDownloadProgress, true)), isStreamResponse && onFinish), options);
    }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51PJD8DSA98h07gMlGzS65Thdv5ap3Z30rsrpMPhJdfAwFoOEwfCbitURKWqw4yDdeygk22PRwePHp1eshcQYxUkE006AkpVBcI');
...
if (map) {
  ...
  (0, _mapbox.initMap)(map, locations);
}
if (loginForm) {
